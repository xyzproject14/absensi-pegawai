...
<body class="body">
    ...
    <div class="container">
        ...
        <div class="container-detail active">
            ...
            <form action="<?= base_url('rekap/ubah_data?id=') ?><?php echo $data->id ?>" method="post">
                <table>
                    <tr>
                ...
                <button type="button" class="action action-back"><a href="<?php echo base_url('rekap') ?>">Kembali</a></button>
                ...
                <div class="container-popup">
                    ...
                    <div class="popup-hapus">
                        ...
                        <a class="action action-save action-oke" href="<?php echo base_url('rekap/hapus_pegawai/' . $data->nip) ?> ">Oke</a>
                    </div>
                </div>
            </form>
